...
namespace BuildingManager.Business.Concrete
{
    public class ExpenseService:IExpenseService
    {
        ...
        public async Task<IDataResult<ExpenseDto>> GetByIdAsync(int id)
        {
            ...
            if (expenseDto != null)  return new SuccessDataResult<ExpenseDto>(expenseDto);
        ...
        public async Task<IDataResult<List<ExpenseDto>>> GetAllAsync()
        {
            ...
            if (expenseDtos != null)  return new SuccessDataResult<List<ExpenseDto>>(expenseDtos);
        ...
        public async Task<IDataResult<PaymentExpenseDto>> GetByIdForPayment(int id)
        {
            ...
            if (expenseDto != null) return new SuccessDataResult<PaymentExpenseDto>(expenseDto);
