...
namespace BuildingManager.Business.Concrete
{
    public class ExpenseTypeService:IExpenseTypeService
    {
        ...
        public async Task<IDataResult<ExpenseTypeDto>> GetByIdAsync(int id)
        {
            ...
            if (expenseTypeDto != null) return new SuccessDataResult<ExpenseTypeDto>(expenseTypeDto);
        ...
        public async Task<IDataResult<List<ExpenseTypeDto>>> GetAllAsync()
        {
            ...
            if (expenseTypeDtos != null) return new SuccessDataResult<List<ExpenseTypeDto>>(expenseTypeDtos);
