...
using BuildingManager.API.Validator;
using Microsoft.AspNetCore.Http;
using Microsoft.AspNetCore.Mvc;
using BuildingManager.API.ApiResponse;
...
namespace BuildingManager.API.Controllers
{
    ...
    public class PaymentController : ControllerBase
    {
        ...
        [Route("CreatePayment")]
        [HttpPost]
        public async Task<ApiResponse<string>> CreatePayment(InvoicePaymentDto createPaymentDto)
        {
